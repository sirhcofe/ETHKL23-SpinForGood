...
export default function Donate() {
  ...
  return (
    <>
      {showWindow && (
        <div className="flex flex-col justify-center items-center h-full flex-1 py-10 px-2">
              ...
              <>
                {!donate && isSuccess ? (
                  ...
                  <>
                    ...
                    <p className="text-center max-w-[400px]">
                      Your awesome donation means you&apos;re in for a chance to join our fun lottery and score some
                      prizes as our way of saying thanks for your support!
                    </p>
                    ...
                    <div className="my-2 w-auto flex flex-col">
                      ...
                      <span className="ml-3  text-primary">{`ETH${(donateVal * 0.25).toFixed(
                        5,
                      )} into Prize Pool`}</span>
                    </div>
                    <ButtonMarquee
                      isLoading={isLoading}
                      disabled={isLoading}
